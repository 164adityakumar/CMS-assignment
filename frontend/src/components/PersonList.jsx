...
function PersonList({ persons,error, setError, handleUpdatePerson, onDeletePerson }) {
  ...
  return (
    <div className="container text-slate-300 ">
      ...
      <div className="text-center font-bold text-2xl my-4 text-slate-300">
        Person{"'"}s Details
      </div>
      {
        persons.length === 0 ? <NoData></NoData> : <div className="row justify-content-center mt-4  bg-slate-800 border border-slate-700 w-[45vw] rounded-md">
